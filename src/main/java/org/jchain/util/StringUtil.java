...
import org.jchain.blockchain.Transaction;
...
public class StringUtil {
    ...
    public static String getMerkleRoot(ArrayList<Transaction> transactions) throws UnsupportedEncodingException, NoSuchAlgorithmException {
